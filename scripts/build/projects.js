...
const tscPath = './node_modules/typescript/lib/tsc';

const projectBuilder = new ProjectQueue((projects, lkg, force) => exec(process.execPath, [tscPath, "-b", ...(force ? ["--force"] : []), ...projects], { hidePrompt: true }));
...
const projectCleaner = new ProjectQueue((projects, lkg) => exec(process.execPath, [tscPath, "-b", "--clean", ...projects], { hidePrompt: true }));
...
const projectWatcher = new ProjectQueue((projects) => exec(process.execPath, [tscPath, "-b", "--watch", ...projects], { hidePrompt: true }));
